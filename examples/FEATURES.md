...
| --- | --- | --- | --- | --- | --- | --- | --- |
| §3 | UTF-8 source, layout, comments, documentation, names, scope | complete | partial | n/a | n/a | partial | Generic-nominal, interface-value, and source-test scopes remain with those features. |
...
| §5 | Scalar, composite, alias, inference, structural operations, and recursive type rules | complete | partial | partial | partial | partial | `f16`, maps/sets, interface values, generic nominal types, hashing, structural list equality, and managed forms beyond the completed class/list/slice/bytes ownership graphs. |
| §6 | Immutable/mutable bindings, assignment, initialization | complete | partial | partial | partial | partial | Class/custom-construction definite initialization and shared mutable closure cells execute; interface/generic managed places remain. |
...
| §8 | Functions, arguments/defaults, tuples, methods, mutation, recursion, and function values | complete | partial | partial | partial | partial | Exact named values, core managed function environments, generic functions, and interface-requirement fallibility lifts execute; dynamic interface calls and the complete default-argument audit remain. |
...
| §10 | Structs, tuples, fixed arrays, enums, copying, visibility | complete | partial | partial | partial | partial | Struct/enum fundamentals, explicit interface conformance, and ownership-safe fixed-array slicing execute; generic nominal types, hashing, and the remaining rule-by-rule audit keep the broad row open. |
...
| §15 | Generic declarations, constraints, monomorphization, limits | complete | partial | partial | partial | partial | Generic functions, interface constraints/intersections, abstract body checking, structural inference, contextual function values, defaults, recursion, memoized instances, and an explicit generator specialization budget reach QBE; nominal generics, serialized typed bodies, package/CLI budget configuration, origin/size/time accounting, and expansion-path diagnostics remain. |
| §16 | Interfaces, conformance, static use, interface values | complete | partial | partial | partial | partial | Nominal requirements, generic interfaces, explicit struct/class/enum conformance, static constrained calls, and fallibility adapters reach QBE. Existential values, witness-table dynamic dispatch, boxing/COW, and dynamic-call cost reporting remain. |
...
| `constrained_generics.luc` | Generic interfaces, explicit conformance, static requirement dispatch, and infallible-to-fallible requirement adaptation | HIR and MIR oracles plus Wasm and native QBE execution. |
