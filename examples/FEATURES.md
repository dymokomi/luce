...
| §12 | Allocation, lists, maps, sets, slices, strings/bytes, arenas | complete | partial | partial | partial | partial | Sealed arena provider, Luce runtime allocator, dynamic collections, slicing, and full string semantics. |
