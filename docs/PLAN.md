...
| Slice | Scope | Gate |
| --- | --- | --- |
| 8. Interfaces and generics | §13: bounds and monomorphisation, `for` over `Iterable` (conformance, interface values and the closed protocols are done) | §13 programs and rejections |
