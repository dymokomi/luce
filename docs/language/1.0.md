...
both remain explicitly `unspecified` until a binding recipe supplies them.
...
pointer record fields, and owned/borrowed wrappers remain rejected until the
recipe and carrier rows below are implemented. Function and array pointer
