...
initializer. Volatile objects remain runtime storage even when `const`; other
scalar object constants extend the value union with their own semantic kinds
rather than masquerading as integers.
