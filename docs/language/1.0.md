...
than masquerading as integers. Macro constants likewise require explicit
selection and Clang evaluation rather than interpretation of preprocessor
replacement text as if it were C semantics. The generated C product
statically verifies every imported constant's type and value against the
included header.
