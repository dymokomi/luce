...
- HirGenerator produces typed HIR with stable symbol and type identities. The
  ...
  nominal interface declarations, explicit struct/class/enum conformance and
  statically dispatched requirement calls, exhaustive `match`,
...
- The compiled slice — every scalar type with checked arithmetic, locals,
  ...
  monomorphized generic functions and constrained interface calls, and
