...
Companion documents: `LUCE_LANGUAGE_DESIGN_POST_1_0.md`, `LUCE_NEXT_BLUEPRINT.md`, `LUCE_UX_ADOPTION_REQUIREMENTS.md`, and `LUCE_CPP_INTEROP_DESIGN.md`
...
Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §20.6.

### 20.7 Dependency identity

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §20.7.

### 20.8 Platform variation

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §20.8.
...
Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §21.6.

### 21.7 Supported C++ subset

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §21.7.

### 21.8 C++ exceptions and failure

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §21.8.

### 21.9 C++ objects and lifetime

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §21.9.

### 21.10 Templates

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §21.10.

### 21.11 Callbacks, threads, and reentrancy

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §21.11.
...
Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §21.13.

### 21.14 Support tiers

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §21.14.
...
Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §23.2.

### 23.3 Backend portfolio

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §23.3.
...
Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §23.5.

### 23.6 ABI layers

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §23.6.

### 23.7 Build profiles

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §23.7.

### 23.8 Determinism and caching

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §23.8.
...
Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §24.1.
...
Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §24.6.

### 24.7 Debugging and observability

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §24.7.

### 24.8 Compiler performance budgets

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §24.8.

### 24.9 Correctness and security gates

Deferred past 1.0 — see `LUCE_LANGUAGE_DESIGN_POST_1_0.md` §24.9.
